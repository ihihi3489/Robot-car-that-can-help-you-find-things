...
class MainWindow(QTabWidget):
    ...
    def initUI(self):
        # 图片检测子界面
        font_title = QFont('繁體', 16)
        font_main = QFont('繁體', 14)
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("")
        ...
        up_img_button = QPushButton("")
        det_img_button = QPushButton("")
        ...
        self.webcam_detection_btn = QPushButton("Start")
        self.mp4_detection_btn = QPushButton("")
        ...
        about_title = QLabel('')
        about_title.setFont(QFont('繁體', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/logo.png'))
        about_img.setAlignment(Qt.AlignCenter)

        label_super = QLabel()
        label_super.setFont(QFont('繁體', 16))
